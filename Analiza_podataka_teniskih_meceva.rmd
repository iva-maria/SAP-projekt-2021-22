...
Zaključak: Možemo odbaciti nultu hipotezu u korist prve hipoteze na razini značajnosti $\alpha$ = 0.01
...
known_ranks = arrange(known_ranks[known_ranks$minutes < 500,], desc(minutes)) # 700
